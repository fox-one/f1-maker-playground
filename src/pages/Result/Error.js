...
const extra = (
  <Fragment>
    ...
    <div style={{ marginBottom: 16 }}>
      ...
      <FormattedMessage id='app.result.error.hint-text1' defaultMessage='Your account has been frozen' />
    ...
    <div>
      <Icon style={{ color: '#f5222d', marginRight: 8 }} type='close-circle-o' />
      <FormattedMessage id='app.result.error.hint-text2' defaultMessage='Your account is not yet eligible to apply' />
      <a style={{ marginLeft: 16 }}>
