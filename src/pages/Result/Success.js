  ...
  <Fragment>
    ...
    <Row style={{ marginBottom: 16 }}>
      ...
      <Col xs={24} sm={24} md={24} lg={24} xl={12}>
        <span style={{ color: 'rgba(0, 0, 0, 0.85)' }}>
          <FormattedMessage id='app.result.success.operate-time' defaultMessage='Effective time：' />
        </span>
    ...
    <Steps style={{ marginLeft: -42, width: 'calc(100% + 84px)' }} progressDot current={1}>
      ...
      <Step
        title={
          <span style={{ fontSize: 14 }}>
            <FormattedMessage id='app.result.success.step2-title' defaultMessage='Departmental preliminary review' />
          </span>
        }
        description={desc2} />
      <Step
